...
<div class="auth_wrapper">
	<div class="auth_buttons d-grid">
		<div class="btn_auth_tab active d-flex align-items-center justify-content-center" data-id="login">Вход</div>
		<div class="btn_auth_tab d-flex align-items-center justify-content-center" data-id="reg">Регистрация</div>
	</div>
	<div class="auth_content">
		<div class="auth-item login_form vis" dataTab-id="login">
		...
		<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
			<div class="auth-item registration_form" dataTab-id="reg">
